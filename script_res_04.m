% -- before PSO
d1=[];  for ii=1:100; d1 =[d1;  VBI_est2_000{ii+1,6}( 1,:,1)']; end
cs1=[]; for ii=1:100; cs1=[cs1; VBI_est2_000{ii+1,6}( 2,:,1)']; end
cs2=[]; for ii=1:100; cs2=[cs2; VBI_est2_000{ii+1,6}( 3,:,1)']; end
ks1=[]; for ii=1:100; ks1=[ks1; VBI_est2_000{ii+1,6}( 4,:,1)']; end
ks2=[]; for ii=1:100; ks2=[ks2; VBI_est2_000{ii+1,6}( 5,:,1)']; end
mu1=[]; for ii=1:100; mu1=[mu1; VBI_est2_000{ii+1,6}( 6,:,1)']; end
mu2=[]; for ii=1:100; mu2=[mu2; VBI_est2_000{ii+1,6}( 7,:,1)']; end
ku1=[]; for ii=1:100; ku1=[ku1; VBI_est2_000{ii+1,6}( 8,:,1)']; end
ku2=[]; for ii=1:100; ku2=[ku2; VBI_est2_000{ii+1,6}( 9,:,1)']; end

ms1=(Veh_1.M-mu1-mu2).*(Veh_1.D-d1)/Veh_1.D;
ms2=(Veh_1.M-mu1-mu2).*(d1)/Veh_1.D;

EI01=[]; for ii=1:100; EI01=[EI01; VBI_est2_000{ii+1,6}(10,:,1)']; end
EI02=[]; for ii=1:100; EI02=[EI02; VBI_est2_000{ii+1,6}(11,:,1)']; end
EI03=[]; for ii=1:100; EI03=[EI03; VBI_est2_000{ii+1,6}(12,:,1)']; end
EI04=[]; for ii=1:100; EI04=[EI04; VBI_est2_000{ii+1,6}(13,:,1)']; end
EI05=[]; for ii=1:100; EI05=[EI05; VBI_est2_000{ii+1,6}(14,:,1)']; end
EI06=[]; for ii=1:100; EI06=[EI06; VBI_est2_000{ii+1,6}(15,:,1)']; end
EI07=[]; for ii=1:100; EI07=[EI07; VBI_est2_000{ii+1,6}(16,:,1)']; end
EI08=[]; for ii=1:100; EI08=[EI08; VBI_est2_000{ii+1,6}(17,:,1)']; end
EI09=[]; for ii=1:100; EI09=[EI09; VBI_est2_000{ii+1,6}(18,:,1)']; end
EI10=[]; for ii=1:100; EI10=[EI10; VBI_est2_000{ii+1,6}(19,:,1)']; end
EI11=[]; for ii=1:100; EI11=[EI11; VBI_est2_000{ii+1,6}(20,:,1)']; end
EI12=[]; for ii=1:100; EI12=[EI12; VBI_est2_000{ii+1,6}(21,:,1)']; end
EI13=[]; for ii=1:100; EI13=[EI13; VBI_est2_000{ii+1,6}(22,:,1)']; end
EI14=[]; for ii=1:100; EI14=[EI14; VBI_est2_000{ii+1,6}(23,:,1)']; end
EI15=[]; for ii=1:100; EI15=[EI15; VBI_est2_000{ii+1,6}(24,:,1)']; end
rA=[]; for ii=1:100; rA=[rA; VBI_est2_000{ii+1,6}(25,:,1)']; end
aC=[]; for ii=1:100; aC=[aC; VBI_est2_000{ii+1,6}(26,:,1)']; end
bC=[]; for ii=1:100; bC=[bC; VBI_est2_000{ii+1,6}(27,:,1)']; end
...
figure(2)
tiledlayout(6,3);
nexttile;histogram(EI01/(Bri_2.EI_DATA(1)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI02/(Bri_2.EI_DATA(2)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI03/(Bri_2.EI_DATA(3)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI04/(Bri_2.EI_DATA(4)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI05/(Bri_2.EI_DATA(5)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI06/(Bri_2.EI_DATA(6)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI07/(Bri_2.EI_DATA(7)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI08/(Bri_2.EI_DATA(8)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI09/(Bri_2.EI_DATA(9)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI10/(Bri_2.EI_DATA(10)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI11/(Bri_2.EI_DATA(11)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI12/(Bri_2.EI_DATA(12)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI13/(Bri_2.EI_DATA(13)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI14/(Bri_2.EI_DATA(14)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(EI15/(Bri_2.EI_DATA(15)),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(rA/(Bri_2.rhoA),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(aC/(Bri_2.aC),0.8:0.01:1.2,'Normalization','Probability');hold on
nexttile;histogram(bC/(Bri_2.bC),0.8:0.01:1.2,'Normalization','Probability');hold on
