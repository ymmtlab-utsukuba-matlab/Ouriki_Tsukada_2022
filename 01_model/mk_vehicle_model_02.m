function [Veh] = mk_vehicle_model_02(Sim)
...
ks1 = 100000; %-- [N/m] spring stiffness of front sus
ks2 = 100000; %-- [N/m] spring stiffness of rear sus
mu1 = 1100; %-- [kg] unsprung-mass at front
mu2 = 1100; %-- [kg] unsprung-mass at rear
ku1 = 3000000; %-- [N/m] spring stiffness of front tyre
ku2 = 3000000; %-- [N/m] spring stiffness of rear tyre

% ms  = 8310;     %-- [kg] mass of the vehicle
% D   = 3.185;      %-- [m] distance between the front-rear axles
% d1  = 1.125;     %-- [m] distance to the front axle from G
% d2  = D-d1;      %-- [m] distance to the rear axle from G
% I   = 30600;     %-- [kg m2] Inertia
% cs1 = 24200;     %-- [kg/s] damping of front sus
% cs2 = 29000;     %-- [kg/s] damping of rear sus
% ks1 = 456000;    %-- [N/m] spring stiffness of front sus
% ks2 = 410000;    %-- [N/m] spring stiffness of rear sus
% mu1 = 496;       %-- [kg] unsprung-mass at front
% mu2 = 751;       %-- [kg] unsprung-mass at rear
% ku1 = 4790000;   %-- [N/m] spring stiffness of front tyre
% ku2 = 4310000;   %-- [N/m] spring stiffness of rear tyre
