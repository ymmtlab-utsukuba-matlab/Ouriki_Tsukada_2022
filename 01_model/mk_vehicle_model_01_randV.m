function [Veh] = mk_vehicle_model_01_randV(Sim)
...
d1  = 1.215;      %-- [m] distance to the front axle from G
...
mu1 = 469.00;     %-- [kg] unsprung-mass at front
mu2 = 751.00;     %-- [kg] unsprung-mass at rear
...
r   = 0.8+0.4*rand(1,1); %-- random running speed(80％-120％)
v   = v*r;
